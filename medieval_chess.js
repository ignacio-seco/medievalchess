...
class NewGame{
    ...
    addPlayer1()
    {
       let name //= nameStringqueryselector 
       if(name!=="")
       {
        this.player1=name
       }
       else this.player1="Player 1"
    }
    addPlayer2()
    {
        let name //= nameStringqueryselector 
...
/*class Player{
    constructor(playerName)
    {
        ...
        this.playerArmy=[]
        this.playerArmyPoints=0
        this.newCharacter=""

    }
addArmy(type){this.newCharacter = new type (this.playerName);
    playerArmy.push(this.newCharacter);
    let newArmyPoints=0
    playerArmy.forEach((element)=>newArmyPoints=newArmyPoints + element.points)
    this.playerArmyPoints=armyPoints
